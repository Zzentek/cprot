          ...
          <div>
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-4 orbitron-font">
                Preguntas <span className="text-blue-600 dark:text-blue-400 relative">
                  frecuentes
                  <svg 
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-900/5 backdrop-blur-sm border border-gray-200 dark:border-blue-400/30 rounded-md overflow-hidden hover:bg-gray-50 dark:hover:bg-transparent hover:border-blue-600/40 dark:hover:border-blue-400/40 hover:bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(30,121,195,0.15)_0%,_transparent_100%)] dark:hover:bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(30,121,195,0.25)_0%,_transparent_100%)] hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300"
                >
                  <button
                    onClick={() => setOpenIndex(openIndex === index ? null : index)}
                    className="w-full px-4 sm:px-3 py-3 sm:py-3 flex items-center text-left gap-2 sm:gap-4"
                  >
                    <span className="orbitron-font flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 rounded-md bg-blue-100 dark:bg-blue-400/20 flex items-center justify-center text-blue-600 dark:text-blue-400 text-sm sm:text-base">
